...
const NavHomeAddNotifiProfile = ({ navigation, activeTab }) => {
  ...
  return (
    <View style={styles.bottomNav}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('LabHomeScreen')} // PatientList screen par le jayega
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.navItem}
        onPress={() => navigation.navigate('ViewPendingPatient')} // AddPatient screen par le jayega
      >
        <Image
          source={require('../../assests/LabTest.png')}
          style={[
            styles.navIconImage,
            { tintColor: activeTab === 'Add' ? activeColor : inactiveColor },
          ]}
        />
        <Text
          style={[
      ...
      <TouchableOpacity
        style={styles.navItem}
        onPress={() => navigation.navigate('AllRecords')} // AddPatient screen par le jayega
      >
        <Image
...
export default NavHomeAddNotifiProfile;
